...
use codicastudio\Avatar\Generator\DefaultGenerator;
...
class InitialGeneratorTest extends TestCase
{
    ...
    {
        $this->assertEquals('ab', $this->generator->make('adi.budi@codicastudio.com'));
        $this->assertEquals('ci', $this->generator->make('citra@codicastudio.com'));
        $this->assertEquals('DA', $this->generator->make('DANI@codicastudio.com'));
    }
}
